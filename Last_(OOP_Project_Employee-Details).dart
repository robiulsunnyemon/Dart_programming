...
class Person1 extends EmployeeDetails {
 ...
 @override
  ...
  void display() {
    print('\nEmployee 1 ->');
    super.display();
    phoneNumber(number: '(+880) 1301331125');
    print('|');
...
void main() {
  ...
  EmployeeDetails ob1 = Person1('Robiul Sunny Emon', 21, 'Software Engineer');
  ob1.display();

  ob1 = Person2('RS Emon', 54, 'Flutter developer');
  ob1.display();

  ob1 = Person3('Sunny', 47, 'SEO');
  ob1.display();

  ob1 = Person4('Emon', 18, 'Web developer');
  ob1.display();
}
